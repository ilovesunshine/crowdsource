 ...
 * @since 1.0
 */
public interface PayAdminsService {
  	/**
	 * <p>根据id查询数据</p>
	 *
	 * @param id
	 * @return Model
	 */
	public Object findById(Long id)  throws DBException;
     ...
     * 根据user属性查询数据
     * @param userId
     * @param adminRoleOptUser
     * @return
     */
    public PayAdmins findByProperty(String userId, String adminRoleOptUser)  throws DBException;
