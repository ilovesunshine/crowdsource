...
public class DateTimeUtil {
	public static int DATE_FORMAT = 2;
	  ...
	  public static String getMaxDate(String strSource)
	  {
	    ...
	    strSource = StringUtils.replace(strSource, "-00", "");
	    strSource = StringUtils.replace(strSource, "-", "");
