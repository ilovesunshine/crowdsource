...
(/** @lends <global> */function( $ ) {
	 ...
	 *  @memberof DataTable#oApi
	 */
	function _fnInitialise ( settings,flag )
	{
		...
		if ( ! settings.bInitialised ) {
			setTimeout( function(){ _fnInitialise( settings,true ); }, 200 );
			return;
		}
	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			{
				_fnInitialise( oSettings,true );
				$(".class_queryform_first").click(function () {
					oSettings._iDisplayStart = 1;
					_fnInitialise( oSettings,false );
				});
			}
		} );
		_that = null;
